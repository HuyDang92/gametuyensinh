   ...
   return (
      (T.matches = function (t, e) {
         ...
         var i,
            ...
            o = !r;
         return (
            o && (r = O).appendChild(t), (i = ~T.qsa(r, e).indexOf(t)), o && O.removeChild(t), i
         );
      }),
      (C = function (t) {
...
(window.Zepto = Zepto),
   ...
   (function (t) {
      ...
      function g(t, e) {
         var n = e.context;
         return e.beforeSend.call(n, t, e) === !1 || p(e, n, "ajaxBeforeSend", [t, e]) === !1
            ? !1
            : void p(e, n, "ajaxSend", [t, e]);
      }
      function v(t, e, n, i) {
         var r = n.context,
            o = "success";
      ...
      function w(t) {
         return (
            t && (t = t.split(";", 2)[0]),
            (t &&
               (t == f ? "html" : t == u ? "json" : s.test(t) ? "script" : a.test(t) && "xml")) ||
               "text"
         );
      }
      function E(t, e) {
      ...
      function j(e) {
         e.processData &&
            ...
            !e.data ||
               ...
               ((e.url = E(e.url, e.data)), (e.data = void 0));
      }
      function S(e, n, i, r) {
         return (
         ...
         (t.ajax = function (e) {
            ...
            d(o),
               o.crossDomain ||
                  ...
                  (a.href = o.url),
                  (a.href = a.href),
                  (o.crossDomain = l.protocol + "//" + l.host != a.protocol + "//" + a.host)),
            ...
            if (
               (f && (u = "jsonp"),
               (o.cache !== !1 && ((e && e.cache === !0) || ("script" != u && "jsonp" != u))) ||
                  (o.url = E(o.url, "_=" + Date.now())),
               "jsonp" == u)
            )
               return (
                  f ||
                     (o.url = E(
                        o.url,
                        o.jsonp ? o.jsonp + "=?" : o.jsonp === !1 ? "" : "callback=?"
                     )),
                  t.ajaxJSONP(o, s)
               );
            var C,
            ...
            if (
               (s && s.promise(S),
               o.crossDomain || m("X-Requested-With", "XMLHttpRequest"),
               m("Accept", h || "*/*"),
               (h = o.mimeType || h) &&
                  (h.indexOf(",") > -1 && (h = h.split(",", 2)[0]),
                  S.overrideMimeType && S.overrideMimeType(h)),
               (o.contentType ||
                  (o.contentType !== !1 && o.data && "GET" != o.type.toUpperCase())) &&
                  m("Content-Type", o.contentType || "application/x-www-form-urlencoded"),
               o.headers)
            )
                     ...
                     if (
                        ...
                        try {
                           "script" == u
                              ...
                              : "xml" == u
                              ? (e = S.responseXML)
                              : "json" == u && (e = c.test(e) ? null : t.parseJSON(e));
                        } catch (i) {
                           n = i;
                        }
...
var store = function (a, b) {
   ...
   var e,
      f = navigator.userAgent.toLowerCase().indexOf("android") > -1,
      g = f ? !1 : !0;
   if (
      ("undefined" != typeof b &&
         null !== b &&
         ("object" == typeof b && (b = JSON.stringify(b)),
         g ? localStorage.setItem(a, b) : c(a, b, 100)),
      "undefined" == typeof b)
   ) {
...
$(function () {
   ...
   function a(a) {
      ...
      return (
         ...
         (this.initVars = function () {
            (this.$game = $("#game").css({ width: k + "px", height: l + "px" })),
               (this.$ads = $(".ads").css({ width: k + "px" })),
               (this.$qrCode = $(".qr-code")),
               H && this.$qrCode.hide(),
         ...
         (this.heroInit = function () {
            ...
            for (var a = 0; a < J.length; a++) {
               ...
               1 !== b &&
                  11 !== b &&
                  c &&
                  $('.wrapper[data-src="' + b + '"]').removeClass("locked"),
                  f.css({ width: d + "px", height: e + "px" }),
         ...
         (this.drawInit = function () {
            (this.drawTotal = store("drawTotal")),
               (this.drawTotal = null === this.drawTotal ? x : parseInt(this.drawTotal, 10)),
               this.updateDraw();
         }),
         ...
         (this.bindEvents = function () {
            ...
            $(".btn-play").on(I, function () {
               ...
               $(".btn-hero").on(I, function (b) {
                  a.$heropick.toggleClass("in"),
                     a.$draw.removeClass("in"),
                     this.isNew || (store("stick-hero-404", !0), a.$newHeroIcon.hide()),
                     b.stopPropagation(),
                     $(document).off(I, ".overlay"),
                     $(document).on(I, ".overlay", function () {
                        $(document).off(I, ".overlay"),
                           a.$draw.removeClass("in"),
                           a.$heropick.removeClass("in");
                     });
               }),
               $(".btn-draw").on(I, function (b) {
                  a.$draw.toggleClass("in"),
                     a.$heropick.removeClass("in"),
                     b.stopPropagation(),
                     $(document).off(I, ".overlay"),
                     $(document).on(I, ".overlay", function () {
               ...
               $(".draw-btn").on(I, function () {
                  event.stopPropagation(), a.drawStart();
               }),
               $(document).on(I, ".heropick .wrapper", function (b) {
                  ...
                  c.hasClass("locked")
                     ? a.total >= d
                        ? (a.updateTotal(-d), a.unlockHero(e))
                        : b.preventDefault()
                     : (a.switchHero(e),
                       $(document).off(I, ".overlay"),
                       a.$heropick.removeClass("in")),
         ...
         (this.begin = function () {
            (this._activeStickHeight = 0),
               (this._validStickMin = this.BOX2.left - o),
               (this._validStickMax = this._validStickMin + this.BOX2.width),
               $(".plus-one").remove(),
               (this.$activeStick = $("<div />")
                  .addClass("stick")
                  .css({ left: r + "px", bottom: s + "px" })),
               this.$game.append(this.$activeStick);
            var a = this;
            (G = !1),
               (F = !1),
               (function b() {
                  ((G && F) || !G) && window.requestAnimationFrame(b),
                     F &&
                        (G ||
                           (a.$heroContainer.addClass("shake"),
                           a.$instruction.removeClass("in"),
                           (G = !0)),
                        (a._activeStickHeight += u),
                        (a.$activeStick[0].style.height = a._activeStickHeight + "px")),
                     !F && G && a.next();
               })();
         }),
         ...
         (this.heroWalk = function () {
            if (
               ((this.dx = this.BOX2.left + this.BOX2.width - o),
               this._activeStickHeight > this._validStickMin &&
                  this._activeStickHeight < this._validStickMax)
            ) {
               if (
                  (this.nextAfterAnimation(this.$hero, K.SHIFTING),
                  (this._perfectMin = this._validStickMin + (this.BOX2.width - v) / 2),
                  (this._perfectMax = this._perfectMin + v),
                  (this.inc = 1),
                  this._activeStickHeight >= this._perfectMin &&
                     this._activeStickHeight <= this._perfectMax)
               ) {
                  ...
                  this.$game.append(a),
                     ...
                     this.count >= w && this.unlockHero(5);
               } else this.count = 0;
               this.$hero.css({
                  transform:
                     "translate3d(" + (this.BOX2.left + this.BOX2.width - d - t - q) + "px, 0, 0)",
                  "-webkit-transform":
                     "translate3d(" + (this.BOX2.left + this.BOX2.width - d - t - q) + "px, 0, 0)",
               ...
               (b = b > 1 ? 1 : b),
                  this.$hero.css({
                     ...
                     "-webkit-transform":
                        "translate3d(" + (o + this._activeStickHeight) + "px, 0, 0)",
         ...
         (this.dying = function () {
            this.nextAfterAnimation(this.$hero, K.DEAD),
               this.$hero.css({
                  transform:
                     "translate3d(" +
                     (o + this._activeStickHeight) +
                     "px, " +
                     (p + e + 50) +
                     "px , 0)",
                  "-webkit-transform":
         ...
         (this.drawStart = function () {
            var a = this;
            if (!(this.isDrawing || this.drawTotal <= 0)) {
               var b = this._getRandom(0, 359),
                  c = 360 * z - b;
               this.$drawPlate.on(E, function () {
                  a.$drawPlate.off(E), a.drawEnd(b);
               }),
                  (this.isDrawing = !0),
                  this.updateDraw(-1),
         ...
         (this.updateScore = function (a) {
            void 0 !== a && (this.score += a),
               this.best < this.score && ((this.best = this.score), store("best", this.best)),
               this.$livescore.text(this.score),
               this.$score.text(this.score),
               this.$best.text(this.best);
         }),
         (this.updateTotal = function (a) {
            void 0 !== a && (this.total += a),
               store("total", this.total),
               this.$total.text(this.total);
         }),
         (this.updateDraw = function (a) {
            void 0 !== a && (this.drawTotal += a),
               store("drawTotal", this.drawTotal),
               this.$drawTotal.text(this.drawTotal),
               this.drawTotal > 0 ? this.$drawIcon.show() : this.$drawIcon.hide();
         }),
         (this._createBox = function () {
            return { left: this._getRandom(A, B), width: this._getRandom(C, D) };
         }),
   ...
   function c(a) {
      return a
         ? a.toLowerCase().replace(/_(.)/g, function (a, b) {
